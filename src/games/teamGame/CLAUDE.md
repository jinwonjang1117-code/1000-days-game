...
- ⬜ Step 3 — procedural floor generation, replacing `rooms/floorLayout.ts`'s hand-authored `TEST_FLOOR`. Only makes sense now that step 2 gives it real archetype content to generate variety with.
